...
RUN crontab -l | { cat; echo "* * * * *  cd /var/www/html/discount-bandit/ &&  /usr/local/bin/php /var/www/html/discount-bandit/artisan queue:work --stop-when-empty>> /var/log/cron-test.log 2>&1"; } | crontab -
